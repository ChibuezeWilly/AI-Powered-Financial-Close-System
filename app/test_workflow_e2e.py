...
def main():
    ...
    if len(awaiting) < 2:
        print("  [WARN] Need at least 2 AWAITING_HUMAN_APPROVAL transactions for full test. Will test available paths only.")
    ...
    if tx_approve:
        ...
        print("  [WARN] No AWAITING_HUMAN_APPROVAL transaction to test approval flow")
    ...
    if tx_reject:
        ...
        print("  [WARN] No second AWAITING_HUMAN_APPROVAL transaction to test rejection flow")
    ...
    if tx_reject:
        ...
        print("  [WARN] No escalated transaction to test manager decision")
